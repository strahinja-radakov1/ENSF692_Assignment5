# web_data_app.py
# June 2024
# Modified by: Strahinja Radakovic
#
...
def book_data():
    ...
    for book in book_results:
        ...
        prices_discouted.append(float(book.find('p', class_="price_color").text[1:])*0.75)

    # Create a DataFrame using the two lists
    book_data = pd.DataFrame(list(zip(titles, prices, prices_discouted)), columns=['Titles','Prices','Sale Prices'])    
...
@app.route("/learn")
def learn():
    learned = "One thing I learned in ENSF 692 is how fun and powerful data manipulation is. Especially in pandas, which is way better than numpy. Hopefully I can find a job doing data work."
    return learned
